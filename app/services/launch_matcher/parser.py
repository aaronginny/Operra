...
# ── Reference data ───────────────────────────────────────────
#
# EMIRATES / AREA_TO_EMIRATE / AREA_DISPLAY moved to app.services.geo.uae
# (platform-refactor) so a second consumer outside this vertical — the
# broker_intel vertical's own area lookups — can import UAE geography
# without reaching into a launch-broadcast parser for it. Re-exported here
# unchanged so every existing import of these three names from *this* module
# (app.services.launch_matcher.contact_signals included) keeps working.
from app.services.geo.uae import AREA_DISPLAY, AREA_TO_EMIRATE, EMIRATES  # noqa: F401
